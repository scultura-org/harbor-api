 ...
 * @param optional nil or *ArtifactApiGetArtifactOpts - Optional Parameters:
     ...
     * @param "WithAccessory" (optional.Bool) -  Specify whether the accessories are included of the returning artifacts.
     * @param "WithSignature" (optional.Bool) -  Specify whether the signature is inclued inside the returning artifacts
     * @param "WithImmutableStatus" (optional.Bool) -  Specify whether the immutable status is inclued inside the tags of the returning artifacts.
...
/*
ArtifactApiService Get the vulnerabilities addition of the specific artifact
Get the vulnerabilities addition of the artifact specified by the reference under the project and repository.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectName The name of the project
 * @param repositoryName The name of the repository. If it contains slash, encode it with URL encoding. e.g. a/b -&gt; a%252Fb
 * @param reference The reference of the artifact, can be digest or tag
 * @param optional nil or *ArtifactApiGetVulnerabilitiesAdditionOpts - Optional Parameters:
     * @param "XRequestId" (optional.String) -  An unique ID for the request
     * @param "XAcceptVulnerabilities" (optional.String) -  A comma-separated lists of MIME types for the scan report or scan summary. The first mime type will be used when the report found for it. Currently the mime type supports &#39;application/vnd.scanner.adapter.vuln.report.harbor+json; version&#x3D;1.0&#39; and &#39;application/vnd.security.vulnerability.report; version&#x3D;1.1&#39;
...
/*
ArtifactApiService List accessories
List accessories of the specific artifact
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectName The name of the project
 * @param repositoryName The name of the repository. If it contains slash, encode it with URL encoding. e.g. a/b -&gt; a%252Fb
 * @param reference The reference of the artifact, can be digest or tag
 * @param optional nil or *ArtifactApiListAccessoriesOpts - Optional Parameters:
     * @param "XRequestId" (optional.String) -  An unique ID for the request
...
type ArtifactApiListAccessoriesOpts struct {
	XRequestId optional.String
	Q          optional.String
...
func (a *ArtifactApiService) ListAccessories(ctx context.Context, projectName string, repositoryName string, reference string, localVarOptionals *ArtifactApiListAccessoriesOpts) ([]Accessory, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param optional nil or *ArtifactApiListArtifactsOpts - Optional Parameters:
     ...
     * @param "WithImmutableStatus" (optional.Bool) -  Specify whether the immutable status is included inside the tags of the returning artifacts. Only works when setting \&quot;with_immutable_status&#x3D;true\&quot;
     * @param "WithAccessory" (optional.Bool) -  Specify whether the accessories are included of the returning artifacts. Only works when setting \&quot;with_accessory&#x3D;true\&quot;
