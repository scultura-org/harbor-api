...
func (a *ProjectApiService) GetProject(ctx context.Context, projectId int64, localVarOptionals *ProjectApiGetProjectOpts) (Project, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *ProjectApiService) GetProjectDeletable(ctx context.Context, projectId int64, localVarOptionals *ProjectApiGetProjectDeletableOpts) (ProjectDeletable, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *ProjectApiService) GetProjectSummary(ctx context.Context, projectId int64, localVarOptionals *ProjectApiGetProjectSummaryOpts) (ProjectSummary, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *ProjectApiService) UpdateProject(ctx context.Context, projectId int64, project ProjectReq, localVarOptionals *ProjectApiUpdateProjectOpts) (*http.Response, error) {
	var (
